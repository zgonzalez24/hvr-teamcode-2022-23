...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 6.461892515498429; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -5; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 1.007666167; //multiplier in the x direction
    public static double Y_MULTIPLIER = 1.032599959; //multiplier in the y direction
